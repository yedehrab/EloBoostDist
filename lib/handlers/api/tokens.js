...
function deleteToken(data, callback) {
    // Kimlik kontrolü
    const id = (0, _fixers.fixVar)('id', data.queryStringObject.id);
...
function updateToken(data, callback) {
    ...
    const id = (0, _fixers.fixVar)('id', data.payload.id);
    const extend = (0, _fixers.fixVar)('extend', data.payload.extend);
