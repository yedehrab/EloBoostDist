...
function createUser(data, callback) {
    ...
    const username = (0, _fixers.fixVar)("username", data.payload.username);
    const email = (0, _fixers.fixVar)("email", data.payload.email);
    const password = (0, _fixers.fixVar)("password", data.payload.password);
    const tosAgreement = (0, _fixers.fixVar)("tosAgreement", data.payload.tosAgreement);
...
function updateUser(data, callback) {
    ...
    const fullName = (0, _fixers.fixVar)("fullName", data.payload.fullName);
    const email = (0, _fixers.fixVar)("email", data.payload.email);
    const phone = (0, _fixers.fixVar)('phone', data.payload.phone);
    const password = (0, _fixers.fixVar)("password", data.payload.password);
